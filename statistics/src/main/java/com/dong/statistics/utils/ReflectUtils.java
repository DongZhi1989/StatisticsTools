...
public class ReflectUtils {
     ...
     * @param targetClass    : 0 means itself, 1 means it's father, and so on...
     ...
     *
     * @param object    object invoked
     * @param function  function name
     * @param parameter "String:str,long:200"
     * @return result of invoked method
     * @throws InvocationTargetException
     * @throws IllegalAccessException
     * @throws NoSuchMethodException
     ...
     * @param owner       target object
     * @param targetClass 0 means itself, 1 means it's father, and so on...
     * @param valueType   e.g. String.class
     * @param value       value of the target fields
     * @return ArrayList<String> of property's name
     * @throws IllegalAccessException
     * @throws IllegalArgumentException
     */
     ...
     *
     * @param owner            target object
     * @param interfaceStrings target interface strings
